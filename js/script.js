...
function displayDetialis(data) {
    ...
    for (let i = 1; i <= 20; i++) {
        ...
        if (data[`strIngredient${i}`] != "") {
            ingred += `
        <span class="recDet">${data[`strMeasure${i}`]} ${data[`strIngredient${i}`]
                }</span>
        `;
        }
    }
...
// get data search By First Letter
    ...
    >
      ...
      <div class="col-md-6">
        ...
        <span class="alert alert-danger w-100 mt-2 d-none" id="valEmail">
         Email not valid *ammar@gmail.com
        </span>
      </div>
      <div class="col-md-6">
        <input
...
// close sideNav when click any tap
